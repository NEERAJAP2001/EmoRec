...
def predict():
    ...
    if request.method == 'POST':
        try:                                      ## try block starts here
            ...
            data = [message]
            if(string_check.search(message) != None):

                return render_template('invalid.html',prediction="String contains Special Characters, Please enter valid input.")                  
            ...
            errors.append("Unable to get URL. Please make sure it's valid and try again.")  ## If any errors would , then this block would execute
